...
;Although this code is found on other tutorial sites, it is based
;on a recommendation in the SNES development manual, and so it is unchanged.
...
Init:
       ...
       stz     INIDSP   ; brightness + screen enable register 
       stz     OBJSEL   ; Sprite register (size + address in VRAM) 
       ...
       stz     TM   ; Main Screen designation (planes, sprites enable) (Disable for bg demo).
       stz     TS   ; Sub Screen designation
       stz     TMW   ; Window mask for Main Screen
       stz     TSW   ; Window mask for Sub Screen
       lda     #$30
       sta     CGSWSEL  ; Color addition & screen addition init setting
